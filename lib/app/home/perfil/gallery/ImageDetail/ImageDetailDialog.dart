                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                            ...
                            children: [
                              CircleAvatar(
                                ...
                                backgroundImage: AssetImage(
                                    'lib/assets/placeholder_user.jpg'), // Imagen de usuario
                              ),
                              SizedBox(width: 8),
                              Column(
                          ...
                          Image.network(
                            imageUrls[index],
                            // Aquí cambia de initialIndex a index
                            fit: BoxFit.cover,
                          ),
                          SizedBox(height: 12),
                          Padding(
                ...
                Expanded(
                  child: Container(
                    ...
                    child: ListView(
                      ...
                      children: [
                        _buildComment('Usuario 1', 'Este es un comentario.',
                            'Hace 1 hora'),
                        _buildComment('Usuario 2', 'Este es otro comentario.',
                            'Hace 2 horas'),
                        _buildComment(
                            'Usuario 3', '¡Gran foto!', 'Hace 3 horas'),
