...
class _FriendsModalState extends State<FriendsModal> {
  ...
  void _copyLink() {
    Clipboard.setData(ClipboardData(text: "https://www.likechat.com.pe/user01"));
...
//para compartir perfil

class ShareModalPerfil extends StatefulWidget {
  final ScrollController scrollController;

  ShareModalPerfil({required this.scrollController});

  @override
  _ShareModalPerfilState createState() => _ShareModalPerfilState();
}

class _ShareModalPerfilState extends State<ShareModalPerfil> {
  List<Map<String, String>> friends = [];
  List<ApplicationWithIcon> installedApps = [];
  bool isLoading = true;
    ...
    return SizedBox(
      ...
      child: CustomScrollView(
        ...
        slivers: [
          SliverPersistentHeader(
            pinned: true,
            delegate: _FixedHeaderDelegateShare(
              child: Container(
                decoration: BoxDecoration(
                  color: isDarkMode ? Colors.grey.shade900.withOpacity(0.9) : Colors.white,
                  borderRadius: BorderRadius.vertical(
                  ...
                  children: [
                    ...
                    Align(
                      ...
                      child: GestureDetector(
                        onTap: () {
                          Navigator.of(context).pop(); // Cierra el modal o regresa a la pantalla anterior
                        },
                        child: Icon(
                          FontAwesomeIcons.close,
                          size: 20,
...
class _FixedHeaderDelegateShare extends SliverPersistentHeaderDelegate {
  final Widget child;

  _FixedHeaderDelegateShare({required this.child});
